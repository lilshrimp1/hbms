                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full">
                        <thead class="bg-white-100">
                            <tr>
                                <th class="px-4 py-2 text-gray-800 font-semibold text-center">User Id</th>
                                <th class="px-4 py-2 text-gray-800 font-semibold text-center">Room Id</th>
                                <th class="px-4 py-2 text-gray-800 font-semibold text-center">Check In</th>
                                <th class="px-4 py-2 text-gray-800 font-semibold text-center">Check Out</th>
                                <th class="px-4 py-2 text-gray-800 font-semibold text-center">Guests</th>
                                <th class="px-4 py-2 text-gray-800 font-semibold text-center">Reservation Status</th>
                                <th class="px-4 py-2 text-gray-800 font-semibold text-center">Room Status</th>
                                <th class="px-4 py-2 text-gray-800 font-semibold text-center">Payment Status</th>

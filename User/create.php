        ...
        <main class="flex-1 p-8">
            ...
            <div class="data-table-container" style="margin-top:300px; position:relative; font-size:20px;">
                ...
                <div class="flex items-right mb-4 justify-end" >
                    <button class="hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" style="border-radius: 1rem; background-color:#1BB3BD;">Add New User</button>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full">
                        ...
                        <tbody class="table-group-divider">    
                            <tr>
                                <td class="px-4 py-2 text-gray-800">Front Desk</td>
                                <td class="px-4 py-2 text-gray-800">frontdesk@example.com</td>
                                <td class="px-4 py-2 text-gray-800">Front Desk</td>
                                <td class="px-4 py-2">
                                ...
                                <td class="px-4 py-2 space-x-2">
                                    ...
                                    <button class="action-button deactivate-button">Deactivate</button>
                                    <button class="action-button reset-password-button">Reset Password</button>
                                </td>
                            </tr>
                            <tr>

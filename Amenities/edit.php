...
<div class="data-table-container">
    ...
    <div class="card-body" style="font-family: Arial, Helvetica, sans-serif;">
                ...
                <div class="col-md-5 mb-3">
                    ...
                    <input type="text" name="price" id="price" class="form-control" value="<?=$amenity->price?>" required>
                </div>
            </div>
            <div class="row gx-3">
                    <div class="col-md-4 mb-3">
                        <label for="description" class="form-label">Description</label>
                        <input type="desctiption" name="description" id="description" class="form-control" value="<?=$amenity->description?>" required>
                    </div>
                    <div class="col-md-3 mb-3"> 
                        <label for="status" class="form-label">Status</label>
                        <select type="text" name="status" id="status" class="form-select" value="<?=$amenity->status?>" required>
                            <option value="" selected hidden>(Activate, Deactivate)</option>
